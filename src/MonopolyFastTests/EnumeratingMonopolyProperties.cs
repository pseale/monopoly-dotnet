...
namespace MonopolyFastTests
{
  ...
  public class EnumeratingMonopolyProperties
  {
    ...
    public void Should_have_correct_information_in_every_single_location()
    {
      ...
      Assert.AreEqual("Mediterranean", Locations.All[1].Property.Name);
      ...
      Assert.AreEqual("Baltic", Locations.All[3].Property.Name);
      ...
      Assert.AreEqual("Oriental", Locations.All[6].Property.Name);
      ...
      Assert.AreEqual("Vermont", Locations.All[8].Property.Name);
      Assert.AreEqual(80, Locations.All[8].Property.SalePrice);

      Assert.IsTrue(Locations.All[9].HasAProperty);
      Assert.AreEqual("Connecticut", Locations.All[9].Property.Name);
      ...
      Assert.AreEqual("St. Charles Place", Locations.All[11].Property.Name);
      ...
      Assert.AreEqual("States", Locations.All[13].Property.Name);
      Assert.AreEqual(140, Locations.All[13].Property.SalePrice);

      Assert.IsTrue(Locations.All[14].HasAProperty);
      Assert.AreEqual("Virginia", Locations.All[14].Property.Name);
      ...
      Assert.AreEqual("St. James Place", Locations.All[16].Property.Name);
      ...
      Assert.AreEqual("Tennessee", Locations.All[18].Property.Name);
      Assert.AreEqual(180, Locations.All[18].Property.SalePrice);

      Assert.IsTrue(Locations.All[19].HasAProperty);
      Assert.AreEqual("New York", Locations.All[19].Property.Name);
      ...
      Assert.AreEqual("Kentucky", Locations.All[21].Property.Name);
      ...
      Assert.AreEqual("Indiana", Locations.All[23].Property.Name);
      Assert.AreEqual(220, Locations.All[23].Property.SalePrice);

      Assert.IsTrue(Locations.All[24].HasAProperty);
      Assert.AreEqual("Illinois", Locations.All[24].Property.Name);
      ...
      Assert.AreEqual("Atlantic", Locations.All[26].Property.Name);
      Assert.AreEqual(260, Locations.All[26].Property.SalePrice);

      Assert.IsTrue(Locations.All[27].HasAProperty);
      Assert.AreEqual("Ventnor", Locations.All[27].Property.Name);
      ...
      Assert.AreEqual("Marvin Gardens", Locations.All[29].Property.Name);
      ...
      Assert.AreEqual("Pacific", Locations.All[31].Property.Name);
      Assert.AreEqual(300, Locations.All[31].Property.SalePrice);

      Assert.IsTrue(Locations.All[32].HasAProperty);
      Assert.AreEqual("North Carolina", Locations.All[32].Property.Name);
      ...
      Assert.AreEqual("Pennsylvania", Locations.All[34].Property.Name);
      ...
      Assert.AreEqual("Park Place", Locations.All[37].Property.Name);
      ...
      Assert.AreEqual("Boardwalk", Locations.All[39].Property.Name);
